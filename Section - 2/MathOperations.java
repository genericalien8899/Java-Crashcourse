public class MathOperations{
    public static void main(String[] args) {
        ...
        System.out.println(" Snape ended up removing marks. Ron actually scored " + (testScores - bonusMarks) +"/10 on his potions test.");
        ...
        System.out.println("The Andromeda Galaxy has "+ (starsInAndromeda/starsInMilkyWay) +" times more stars.");
        ...
        counter++;
        counter++;
        System.out.println("Incremeted counter value: " + counter);
        counter--;
        counter--;
        counter--;
        System.out.println("Decremented counter value: " + counter);
    }
